...
.moreme-embed .mm-pill { display: inline-block; padding: 2px 8px; border-radius: 999px; font-size: 10px; font-weight: 700; letter-spacing: .04em; }
...
.moreme-embed .mm-dow { text-align: center; font-size: 10px; letter-spacing: .06em; color: ${T.inkTiny}; padding-bottom: 4px; }
...
.moreme-embed .mm-field > label { font-size: 11px; letter-spacing: .02em; color: ${T.inkTiny}; }
