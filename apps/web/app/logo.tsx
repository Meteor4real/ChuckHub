...
// tile, with the DP (Dude Perfect) mint kept as the accent. Same mark and
// palette as apps/desktop/build/icon.svg and the in-app MoreMeMark
// (moreme/ui.tsx), so the download page and the installed app actually
// match.
